package id.ac.poliban.va.dwi.e020320002.hellosharedprefs9_1;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.va.dwi.e020320002.hellosharedprefs9_1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("HelloSharedPrefs_Dwi");
