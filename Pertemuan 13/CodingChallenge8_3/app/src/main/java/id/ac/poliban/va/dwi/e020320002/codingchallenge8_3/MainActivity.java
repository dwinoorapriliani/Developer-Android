package id.ac.poliban.va.dwi.e020320002.codingchallenge8_3;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Notification Scheduler Challenge_Dwi");
